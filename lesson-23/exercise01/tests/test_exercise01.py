...
def test_wrong_ip():
    with pytest.raises(ValueError) as excinfo:
        ip1 = exercise01.IPAddress("10.1.1.1/240")
    with pytest.raises(ValueError) as excinfo:
        ip1 = exercise01.IPAddress("10.1.400.1/24")