...
from pyeng_common_functions import (check_attr_or_method, check_class_exists,
                                     check_pytest)
...
def test_class_created():
    check_class_exists(exercise02, "IPAddress")


def test_attr_topology():
    """Проверяем, что в объекте IPAddress есть атрибуты ip и mask"""
    return_ip = exercise02.IPAddress("10.1.1.1/24")
...
def test_str_method():
    """Проверяем __str__"""
    return_ip = exercise02.IPAddress("10.5.5.5/24")
