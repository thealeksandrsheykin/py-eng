...
Например, если функции передать как аргументы список headers и список
    [("R1", "12.4(24)T1", "Cisco 3825"), ("R2", "15.2(2)T1", "Cisco 2911")]
...
def convert_to_dict(headers,data):
    '''
    Функция конвертит кортеж в словарь, где ключи это передаваемый список с полями,а значения это передаваемы кортеж.
    :param headers: список с названием полей
    :param data: список кортежей со значениями
    :return: список словарей
    '''

    return [dict(zip(headers,value)) for value in data]
...
if __name__ == '__main__':
    ...
    for i in convert_to_dict(headers,data):
        print(i)