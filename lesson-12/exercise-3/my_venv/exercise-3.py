...
# Способ №2
def print_ip_table_2(reach,unreach):
    my_dict = {'Reachable':reach, 'Unreachable':unreach}
    print(tabulate(my_dict,headers='keys',tablefmt='pipe',stralign='center'))
...
if __name__ == '__main__':
    ...
    print('Способ №2:')
    print_ip_table_2(reach, unreach)
