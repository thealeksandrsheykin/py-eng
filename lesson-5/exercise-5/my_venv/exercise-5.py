...
tmpdata = london_co.get(device,{'Device':'Unknown'})
parameter = input('Введите имя параметра ({}): '.format(','.join(list(tmpdata.keys()))))
msg = '{} or {} is not list'.format(device.upper(),parameter.upper())
print(tmpdata.get(parameter.lower(),msg))
